...
class SeriesDataMarkerHover extends BaseSeriesMarkerHover {
  /**
    ...
    *
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/plotoptions/halo/"="_blank">Halo options</a>
    */
...
object SeriesMarkerHover {
  ...
  def apply(enabled: Option[Boolean] = None,
            ...
            lineWidthPlus: Option[Double] = None,
            radius: Option[Double] = None,
            radiusPlus: Option[Double] = None): SeriesMarkerHover = {
    ...
    val radiusPlusOuter = radiusPlus.orUndefined
...
object SeriesDataMarkerHover {
  ...
  def apply(enabled: Option[Boolean] = None,
            lineWidth: Option[Double] = None,
            lineWidthPlus: Option[Double] = None,
            halo: Option[Boolean | SeriesHoverHalo] = None): SeriesDataMarkerHover = {
    val enabledOuter = enabled.orUndefined
    val lineWidthOuter = lineWidth.orUndefined
    val lineWidthPlusOuter = lineWidthPlus.orUndefined
