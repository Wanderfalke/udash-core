...
class SeriesBarStatesHover extends SeriesStatesHover {
  ...
  /**
    ...
    *
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/plotoptions/column-states-hover-brightness/" target="_blank">Brighten by 0.5</a>
    */
...
object SeriesAreaStatesHover {
  ...
  def apply(enabled: Option[Boolean] = None,
            halo: Option[SeriesHoverHalo] = None,
            lineWidth: Option[Double] = None,
            lineWidthPlus: Option[Double] = None): SeriesAreaStatesHover = {
    val enabledOuter = enabled.orUndefined
    val haloOuter = halo.orUndefined
    val lineWidthOuter = lineWidth.orUndefined
    val lineWidthPlusOuter = lineWidthPlus.orUndefined
...
object SeriesBarStatesHover {
  ...
  def apply(enabled: Option[Boolean] = None,
            ...
            color: Option[Color] = None): SeriesBarStatesHover = {
    val enabledOuter = enabled.orUndefined
    val haloOuter = halo.orUndefined
    val borderColorOuter = borderColor.map(_.c).orUndefined
    val brightnessOuter = brightness.orUndefined
