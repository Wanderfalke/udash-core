...
import io.udash.wrappers.highcharts.config.series.funnel.SeriesFunnelData
...
object SeriesGauge {
  ...
  /**
    ...
    */
  def apply(animation: Option[Animation] = None,
            ...
            dial: Option[SeriesGaugeDial] = None,
            ...
            overshoot: Option[Double] = None,
            pivot: Option[SeriesGaugePivot] = None,
            ...
            xAxis: Option[Double | String] = None,
            yAxis: Option[Double | String] = None,
            zIndex: Option[Int] = None): SeriesGauge = {
    ...
    val dialOuter = dial.orUndefined
    ...
    val overshootOuter = overshoot.orUndefined
    val pointOuter = point.orUndefined
    val pivotOuter = pivot.orUndefined
    ...
    val wrapOuter = wrap.orUndefined
