...
import io.udash.wrappers.highcharts.config.series.{BaseTwoDimSeriesData, SeriesDataEvents, SeriesDataLabels, SeriesDataMarker}
...
object SeriesWaterfallData {
  ...
  def apply(color: Option[Color] = None,
            ...
            isIntermediateSum: Option[Boolean] = None,
            isSum: Option[Boolean] = None,
            labelRank: Option[Double] = None,
            name: Option[String] = None,
            selected: Option[Boolean] = None,
            x: Option[Double] = None,
            y: Option[Double] = None): SeriesWaterfallData = {
    ...
    val isIntermediateSumOuter = isIntermediateSum.orUndefined
    val isSumOuter = isSum.orUndefined
