...
object SeriesHeatmap {
  ...
  def apply(allowPointSelect: Option[Boolean] = None,
            ...
            nullColor: Option[Color] = None,
            point: Option[SeriesPoint] = None,
            rowsize: Option[Double] = None,
            ...
            zones: Option[Seq[SeriesZone]] = None): SeriesHeatmap = {
    ...
    val colsizeOuter = colsize.orUndefined
    ...
    val nullColorOuter = nullColor.map(_.c).orUndefined
    val pointOuter = point.orUndefined
    val rowsizeOuter = rowsize.orUndefined
