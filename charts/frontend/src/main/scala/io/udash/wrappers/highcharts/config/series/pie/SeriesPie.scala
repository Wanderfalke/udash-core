...
object SeriesPie {
  ...
  def apply(allowPointSelect: Option[Boolean] = None,
            ...
            endAngle: Option[Double] = None,
            events: Option[SeriesEvents] = None,
            getExtremesFromAll: Option[Boolean] = None,
            id: Option[String] = None,
            ignoreHiddenPoint: Option[Boolean] = None,
            index: Option[Double] = None,
            innerSize: Option[String | Double] = None,
            ...
            zones: Option[Seq[SeriesZone]] = None): SeriesPie = {
    ...
    val startAngleOuter = startAngle.orUndefined
