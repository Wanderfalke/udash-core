...
object AxisBreak {
  ...
  /**
    ...
    */
  def apply(breakSize: Option[Double] = None,
            from: Option[Double] = None,
            repeat: Option[Double] = None,
            to: Option[Double] = None): AxisBreak = {
    val breakSizeOuter = breakSize.orUndefined
    val fromOuter = from.orUndefined
    val repeatOuter = repeat.orUndefined
