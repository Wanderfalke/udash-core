...
import io.udash.wrappers.highcharts.config.series.line.SeriesLineData
...
object SeriesSpline {
  ...
  def apply(allowPointSelect: Option[Boolean] = None,
            ...
            zones: Option[Seq[SeriesZone]] = None): SeriesSpline = {
    ...
    val stackOuter = stack.orUndefined
    val stackingOuter = stacking.orUndefined
