...
import io.udash.wrappers.highcharts.config.series.{BaseXSeriesData, SeriesDataEvents, SeriesDataLabels, SeriesRangeDataLabels}
...
object SeriesArearangeData {
  ...
  def apply(color: Option[Color] = None,
            ...
            x: Option[Double] = None): SeriesArearangeData = {
