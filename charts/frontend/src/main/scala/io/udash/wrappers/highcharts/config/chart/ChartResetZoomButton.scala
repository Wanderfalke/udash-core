...
import io.udash.wrappers.highcharts.config.utils.{Align, Position, VerticalAlign}
...
object ChartResetZoomButton {
  ...
  /**
    ...
    */
  def apply(position: Option[Position] = None,
            relativeTo: Option[String] = None,
            theme: Option[String] = None): ChartResetZoomButton = {
