...
trait Chart extends js.Object {
  ...
  /**
    ...
    */
  private[highcharts] def addAxis(options: config.axis.Axis[_, _], isX: Boolean, redraw: Boolean = js.native, animation: Boolean | js.Object = js.native): Unit = js.native
  ...
  /**
    ...
    */
  private[highcharts] def addSeries(options: SeriesConfig, redraw: Boolean = js.native, animation: Boolean | js.Object = js.native): Series = js.native
  ...
  /**
    ...
    */
  private[highcharts] def getSelectedPoints(): js.Array[Point] = js.native
  ...
  /**
    ...
    */
  private[highcharts] def getSelectedSeries(): js.Array[Series] = js.native
  ...
  /**
    ...
    */
  private[highcharts] def redraw(animation: Boolean | js.Object = js.native): Unit = js.native
  ...
  private[highcharts] def series: js.Array[Series] = js.native
  ...
  /**
    ...
    */
  private[highcharts] def setSize(width: js.UndefOr[Double] = js.native, height: js.UndefOr[Double] = js.native, animation: Boolean | js.Object = js.native): Unit = js.native
  ...
  private[highcharts] def xAxis: js.Array[XAxis] = js.native

  /** An array of the chart's y axes. If only one y axis, it is referenced by <code>chart.yAxis[0]</code>. */
  private[highcharts] def yAxis: js.Array[YAxis] = js.native
}
...
object Chart {
  ...
  implicit class ChartExt(val chart: Chart) extends AnyVal {
    ...
    def addXAxis(options: config.axis.XAxis, redraw: Boolean = true, animation: Animation = Animation.Enabled): Unit =
      chart.addAxis(options, true, redraw, animation.value)
    ...
    def addYAxis(options: config.axis.YAxis, redraw: Boolean = true, animation: Animation = Animation.Enabled): Unit =
      chart.addAxis(options, false, redraw, animation.value)
    ...
    /**
      ...
      * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/members/chart-addseries/" target="_blank">Add a series from a button</a>
      */
    private[highcharts] def addSeries(options: SeriesConfig, redraw: Boolean = true, animation: Animation = Animation.Enabled): Series =
      chart.addSeries(options, redraw, animation.value)
    ...
    /**
      ...
      * @example <a href="http://jsfiddle.net/gh/get/jquery/1.9.1/highslide-software/highcharts.com/tree/master/samples/highcharts/members/chart-setsize-button/" target="_blank">Test resizing from buttons</a>, <a href="http://jsfiddle.net/gh/get/jquery/1.9.1/highslide-software/highcharts.com/tree/master/samples/highcharts/members/chart-setsize-jquery-resizable/" target="_blank">add a jQuery UI resizable</a>
      */
    def setSize(width: Option[Double] = None, height: Option[Double] = None, animation: Animation = Animation.Enabled): Unit =
      chart.setSize(width.orUndefined, height.orUndefined, animation.value)
