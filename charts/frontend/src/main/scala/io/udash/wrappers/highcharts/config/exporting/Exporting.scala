...
object Exporting {
  ...
  /**
    ...
    */
  def apply(allowHTML: Option[Boolean] = None,
            buttons: Option[ExportingButtons] = None,
            chartOptions: Option[HighchartsConfig] = None,
            enabled: Option[Boolean] = None,
            error: Option[() => Any] = None,
            fallbackToExportServer: Option[Boolean] = None,
            filename: Option[String] = None,
            formAttributes: Option[js.Object] = None,
            printMaxWidth: Option[Double] = None,
            scale: Option[Double] = None,
            sourceHeight: Option[Double] = None,
            sourceWidth: Option[Double] = None,
            `type`: Option[ExportType] = None,
            url: Option[String] = None,
            width: Option[Double] = None): Exporting = {
    val allowHTMLOuter = allowHTML.orUndefined
    val buttonsOuter = buttons.orUndefined
    val chartOptionsOuter = chartOptions.orUndefined
    val enabledOuter = enabled.orUndefined
    val errorOuter = error.map(js.Any.fromFunction0).orUndefined
    val fallbackToExportServerOuter = fallbackToExportServer.orUndefined
    val filenameOuter = filename.orUndefined
    val formAttributesOuter = formAttributes.orUndefined
    val printMaxWidthOuter = printMaxWidth.orUndefined
    val scaleOuter = scale.orUndefined
    val sourceHeightOuter = sourceHeight.orUndefined
    val sourceWidthOuter = sourceWidth.orUndefined
    val typeOuter = `type`.map(_.name).orUndefined
    val urlOuter = url.orUndefined
