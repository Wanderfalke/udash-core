...
trait Axis[AxisType <: config.axis.Axis[AxisType, _], PlotBand <: AxisPlotBand] extends js.Object {
  ...
  /**
    ...
    */
  private[highcharts] def setCategories(categories: js.Array[String], redraw: Boolean = js.native): Unit = js.native
  ...
  /**
    ...
    */
  private[highcharts] def setExtremes(min: Double, max: Double, redraw: Boolean = js.native, animation: Boolean | js.Object = js.native): Unit = js.native
...
object Axis {
  ...
  implicit class AxisExt(val axis: Axis[_, _]) extends AnyVal {
    ...
    def setCategories(categories: Seq[String], redraw: Boolean = true): Unit =
      axis.setCategories(categories.toJSArray, redraw)
    ...
    def setExtremes(min: Double, max: Double, redraw: Boolean = true, animation: Animation = Animation.Enabled): Unit =
      axis.setExtremes(min, max, redraw, animation.value)
  }
}
