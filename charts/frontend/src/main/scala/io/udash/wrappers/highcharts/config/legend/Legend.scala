...
object Legend {
  ...
  def apply(align: Option[Align] = None,
            ...
            itemDistance: Option[Double] = None,
            itemHiddenStyle: Option[String] = None,
            itemHoverStyle: Option[String] = None,
            itemMarginBottom: Option[Double] = None,
            itemMarginTop: Option[Double] = None,
            itemStyle: Option[String] = None,
            itemWidth: Option[Double] = None,
            labelFormat: Option[String] = None,
            labelFormatter: Option[(Either[Series, Point] => String)] = None,
            layout: Option[Layout] = None,
            lineHeight: Option[Double] = None,
            margin: Option[Double] = None,
            maxHeight: Option[Double] = None,
            navigation: Option[LegendNavigation] = None,
            padding: Option[Double] = None,
            reversed: Option[Boolean] = None,
            rtl: Option[Boolean] = None,
            shadow: Option[Shadow] = None,
            symbolHeight: Option[Double] = None,
            symbolPadding: Option[Double] = None,
            symbolRadius: Option[Double] = None,
            symbolWidth: Option[Double] = None,
            title: Option[LegendTitle] = None,
            useHTML: Option[Boolean] = None,
            verticalAlign: Option[VerticalAlign] = None,
            width: Option[Double] = None,
            x: Option[Double] = None,
            y: Option[Double] = None): Legend = {
    ...
    val itemDistanceOuter = itemDistance.orUndefined
    val itemHiddenStyleOuter = itemHiddenStyle.map(stringToStyleObject).orUndefined
    val itemHoverStyleOuter = itemHoverStyle.map(stringToStyleObject).orUndefined
    val itemMarginBottomOuter = itemMarginBottom.orUndefined
    val itemMarginTopOuter = itemMarginTop.orUndefined
    val itemStyleOuter = itemStyle.map(stringToStyleObject).orUndefined
    val itemWidthOuter = itemWidth.orUndefined
    val labelFormatOuter = labelFormat.orUndefined
    ...
    val layoutOuter = layout.map(_.name).orUndefined
    val lineHeightOuter = lineHeight.orUndefined
    val marginOuter = margin.orUndefined
    val maxHeightOuter = maxHeight.orUndefined
    val navigationOuter = navigation.orUndefined
    val paddingOuter = padding.orUndefined
    val reversedOuter = reversed.orUndefined
    val rtlOuter = rtl.orUndefined
    val shadowOuter = shadow.map(_.value).orUndefined
    val symbolHeightOuter = symbolHeight.orUndefined
    val symbolPaddingOuter = symbolPadding.orUndefined
    val symbolRadiusOuter = symbolRadius.orUndefined
    val symbolWidthOuter = symbolWidth.orUndefined
