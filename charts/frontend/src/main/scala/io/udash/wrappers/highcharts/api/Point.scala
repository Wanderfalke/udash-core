...
trait Point extends js.Object {
  ...
  /**
    ...
    */
  private[highcharts] def remove(redraw: Boolean = js.native, animation: Boolean | js.Object = js.native): Unit = js.native
  ...
  /**
    ...
    */
  private[highcharts] def slice(sliced: Boolean = js.native, redraw: Boolean = js.native, animation: Boolean | js.Object = js.native): Unit = js.native
  ...
  /**
    ...
    */
  private[highcharts] def update(options: BaseSeriesData[_], redraw: Boolean = js.native, animation: Boolean | js.Object = js.native): Unit = js.native
...
object Point {
  implicit class PointExt(val point: Point) extends AnyVal {
    ...
    def remove(redraw: Boolean = true, animation: Animation = Animation.Enabled): Unit =
      point.remove(redraw, animation.value)
    ...
    def slice(sliced: Boolean, redraw: Boolean = true, animation: Animation = Animation.Enabled): Unit =
      point.slice(sliced, redraw, animation.value)
    ...
    def update(options: BaseSeriesData[_], redraw: Boolean = true, animation: Animation = Animation.Enabled): Unit =
      point.update(options, redraw, animation.value)
  }
}