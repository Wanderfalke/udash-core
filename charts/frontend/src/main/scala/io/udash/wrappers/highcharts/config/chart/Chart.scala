...
object Chart {
  ...
  /**
    ...
    */
  def apply(alignTicks: Option[Boolean] = None,
            ...
            colorCount: Option[Int] = None,
            description: Option[String] = None,
            events: Option[ChartEvents] = None,
            height: Option[Double] = None,
            ignoreHiddenSeries: Option[Boolean] = None,
            inverted: Option[Boolean] = None,
            margin: Option[Margins] = None,
            options3d: Option[ChartOptions3d] = None,
            panKey: Option[String] = None,
            panning: Option[Boolean] = None,
            pinchType: Option[String] = None,
            plotBackgroundColor: Option[Color] = None,
            plotBackgroundImage: Option[String] = None,
            plotBorderColor: Option[Color] = None,
            plotBorderWidth: Option[Double] = None,
            plotShadow: Option[Shadow] = None,
            polar: Option[Boolean] = None,
            reflow: Option[Boolean] = None,
            renderTo: Option[String | js.Object] = None,
            resetZoomButton: Option[ChartResetZoomButton] = None,
            selectionMarkerFill: Option[Color] = None,
            shadow: Option[Shadow] = None,
            showAxes: Option[Boolean] = None,
            spacing: Option[Spacing] = None,
            style: Option[String] = None,
            typeDescription: Option[String] = None,
            width: Option[Double] = None,
            zoomType: Option[ZoomType] = None): Chart = {
    val alignTicksOuter = alignTicks.orUndefined
    ...
    val colorCountOuter = colorCount.orUndefined
    val descriptionOuter = description.orUndefined
    val eventsOuter = events.orUndefined
    val heightOuter = height.orUndefined
    val ignoreHiddenSeriesOuter = ignoreHiddenSeries.orUndefined
    val invertedOuter = inverted.orUndefined
    val marginOuter = margin.map(m => js.Array(m.top, m.right, m.bottom, m.left)).orUndefined
    val options3dOuter = options3d.orUndefined
    val panKeyOuter = panKey.orUndefined
    val panningOuter = panning.orUndefined
    val pinchTypeOuter = pinchType.orUndefined
    val plotBackgroundColorOuter = plotBackgroundColor.map(_.c).orUndefined
    val plotBackgroundImageOuter = plotBackgroundImage.orUndefined
    val plotBorderColorOuter = plotBorderColor.map(_.c).orUndefined
    val plotBorderWidthOuter = plotBorderWidth.orUndefined
    val plotShadowOuter = plotShadow.map(_.value).orUndefined
    val polarOuter = polar.orUndefined
    val reflowOuter = reflow.orUndefined
    val renderToOuter = renderTo.orUndefined
    val resetZoomButtonOuter = resetZoomButton.orUndefined
    val selectionMarkerFillOuter = selectionMarkerFill.map(_.c).orUndefined
    val shadowOuter = shadow.map(_.value).orUndefined
    val showAxesOuter = showAxes.orUndefined
    val spacingOuter = spacing.map(s => js.Array(s.top, s.right, s.bottom, s.left)).orUndefined
    val styleOuter = style.map(stringToStyleObject).orUndefined
    val typeDescriptionOuter = typeDescription.orUndefined
    val widthOuter = width.orUndefined
    val zoomTypeOuter = zoomType.map(_.value).orUndefined
