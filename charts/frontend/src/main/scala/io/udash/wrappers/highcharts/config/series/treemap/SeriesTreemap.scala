...
object SeriesTreemap {
  ...
  /**
    ...
    */
  def apply(allowDrillToNode: Option[Boolean] = None,
            allowPointSelect: Option[Boolean] = None,
            alternateStartingDirection: Option[Boolean] = None,
            ...
            interactByLeaf: Option[Boolean] = None,
            keys: Option[Seq[String]] = None,
            layoutAlgorithm: Option[LayoutAlgorithm] = None,
            layoutStartingDirection: Option[LayoutStartingDirection] = None,
            legendIndex: Option[Double] = None,
            levelIsConstant: Option[Boolean] = None,
            levels: Option[Seq[SeriesTreemapLevels]] = None,
            ...
            zones: Option[Seq[SeriesZone]] = None): SeriesTreemap = {
    val allowDrillToNodeOuter = allowDrillToNode.orUndefined
    val allowPointSelectOuter = allowPointSelect.orUndefined
    val alternateStartingDirectionOuter = alternateStartingDirection.orUndefined
    ...
    val interactByLeafOuter = interactByLeaf.orUndefined
    val keysOuter = keys.map(_.toJSArray).orUndefined
    val layoutAlgorithmOuter = layoutAlgorithm.map(_.name).orUndefined
    val layoutStartingDirectionOuter = layoutStartingDirection.map(_.name).orUndefined
    val legendIndexOuter = legendIndex.orUndefined
    val levelIsConstantOuter = levelIsConstant.orUndefined
    val levelsOuter = levels.map(_.toJSArray).orUndefined
    ...
    val sortIndexOuter = sortIndex.orUndefined
