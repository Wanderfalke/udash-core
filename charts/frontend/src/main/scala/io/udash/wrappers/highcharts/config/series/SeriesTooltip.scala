...
object SeriesTooltip {
  ...
  /**
    ...
    */
  def apply(dateTimeLabelFormats: Option[DateTimeLabelFormats] = None,
    ...
    val pointFormatterOuter = pointFormatter.map(ThisFunction.fromFunction1[Point, String]).orUndefined
