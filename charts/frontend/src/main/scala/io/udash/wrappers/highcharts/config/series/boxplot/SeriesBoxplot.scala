...
object SeriesBoxplot {
  ...
  def apply(allowPointSelect: Option[Boolean] = None,
            ...
            medianColor: Option[Color] = None,
            medianWidth: Option[Double] = None,
            ...
            zones: Option[Seq[SeriesZone]] = None): SeriesBoxplot = {
    ...
    val medianColorOuter = medianColor.map(_.c).orUndefined
    val medianWidthOuter = medianWidth.orUndefined
