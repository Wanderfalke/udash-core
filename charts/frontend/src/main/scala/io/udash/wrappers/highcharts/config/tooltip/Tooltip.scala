...
object Tooltip {
  ...
  /**
    ...
    */
  def apply(animation: Option[Boolean] = None,
            ...
            formatter: Option[(Tooltip.FormatterData) => String | Boolean] = None,
            headerFormat: Option[String] = None,
            hideDelay: Option[Double] = None,
            pointFormat: Option[String] = None,
            pointFormatter: Option[(Point) => String | Boolean] = None,
            positioner: Option[(Double, Double, Point) => Tooltip.Coords] = None,
            shadow: Option[Boolean] = None,
            shape: Option[String] = None,
            shared: Option[Boolean] = None,
            snap: Option[Double] = None,
            style: Option[String] = None,
            useHTML: Option[Boolean] = None,
            valueDecimals: Option[Double] = None,
            valuePrefix: Option[String] = None,
            valueSuffix: Option[String] = None,
            xDateFormat: Option[String] = None): Tooltip = {
    ...
    val followPointerOuter = followPointer.orUndefined
    val followTouchMoveOuter = followTouchMove.orUndefined
    val footerFormatOuter = footerFormat.orUndefined
    val formatterOuter = formatter.map(ThisFunction.fromFunction1[Tooltip.FormatterData, String | Boolean]).orUndefined
    val headerFormatOuter = headerFormat.orUndefined
    val hideDelayOuter = hideDelay.orUndefined
    val pointFormatOuter = pointFormat.orUndefined
    val pointFormatterOuter = pointFormatter.map(ThisFunction.fromFunction1[Point, String | Boolean]).orUndefined
    val positionerOuter = positioner.map(js.Any.fromFunction3[Double, Double, Point, Tooltip.Coords]).orUndefined
    val shadowOuter = shadow.orUndefined
    val shapeOuter = shape.orUndefined
    val sharedOuter = shared.orUndefined
    val snapOuter = snap.orUndefined
    val styleOuter = style.map(stringToStyleObject).orUndefined
    val useHTMLOuter = useHTML.orUndefined
    val valueDecimalsOuter = valueDecimals.orUndefined
    val valuePrefixOuter = valuePrefix.orUndefined
    val valueSuffixOuter = valueSuffix.orUndefined
    val xDateFormatOuter = xDateFormat.orUndefined
