...
object Drilldown {
  ...
  /**
    ...
    */
  def apply(activeAxisLabelStyle: Option[String] = None,
            activeDataLabelStyle: Option[String] = None,
            allowPointDrilldown: Option[Boolean] = None,
            animation: Option[Animation] = None,
            drillUpButton: Option[DrilldownDrillUpButton] = None,
            series: Option[Seq[Series]] = None): Drilldown = {
    val activeAxisLabelStyleOuter = activeAxisLabelStyle.map(stringToStyleObject).orUndefined
    val activeDataLabelStyleOuter = activeDataLabelStyle.map(stringToStyleObject).orUndefined
    val allowPointDrilldownOuter = allowPointDrilldown.orUndefined
    val animationOuter = animation.map(_.value).orUndefined
    val drillUpButtonOuter = drillUpButton.orUndefined
