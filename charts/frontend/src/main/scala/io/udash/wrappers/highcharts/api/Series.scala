...
trait Series extends js.Object {
  ...
  /**
    ...
    */
  // TODO not verified
  def addPoint(options: BaseSeriesData[_] = js.native, redraw: Boolean = js.native, shift: Boolean = js.native, animation: Boolean | js.Object = js.native): Unit = js.native
  ...
  /**
    ...
    */
  private[highcharts] def data: js.Array[Point] = js.native
  ...
  /**
    * Remove a point from the series. Unlike the <a href="#Point.remove">Point.remove</a> method, this can also
    * be done on a point that is not instanciated because it is outside the view or subject to data grouping.
    *
    ...
    */
  private[highcharts] def removePoint(index: Int, redraw: Boolean = js.native, animation: Boolean | js.Object = js.native): Unit = js.native
...
object Series {
  ...
  implicit class SeriesExt(val series: Series) extends AnyVal {
    ...
    def removePoint(index: Int, redraw: Boolean = true, animation: Animation = Animation.Enabled): Unit =
      series.removePoint(index, redraw, animation.value)
  }
}