...
object SeriesBubble {
  ...
  def apply(allowPointSelect: Option[Boolean] = None,
            ...
            displayNegative: Option[Boolean] = None,
            ...
            marker: Option[SeriesMarker] = None,
            ...
            sizeBy: Option[String] = None,
            sizeByAbsoluteValue: Option[Boolean] = None,
            ...
            zThreshold: Option[Double] = None,
            zoneAxis: Option[String] = None,
            zones: Option[Seq[SeriesZone]] = None): SeriesBubble = {
    ...
    val displayNegativeOuter = displayNegative.orUndefined
    ...
    val maxSizeOuter = maxSize.orUndefined
    ...
    val sizeByOuter = sizeBy.orUndefined
    val sizeByAbsoluteValueOuter = sizeByAbsoluteValue.orUndefined
    ...
    val thresholdOuter = threshold.orUndefined
    ...
    val zMaxOuter = zMax.orUndefined
    val zMinOuter = zMin.orUndefined
    val zThresholdOuter = zThreshold.orUndefined
