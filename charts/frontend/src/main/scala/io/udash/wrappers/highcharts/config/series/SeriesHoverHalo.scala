...
object SeriesHoverHalo {
  ...
  /**
    ...
    */
  def apply(attributes: Option[js.Object] = None, opacity: Option[Double] = None, size: Option[Double] = None): SeriesHoverHalo = {
    val attributesOuter = attributes.orUndefined
    val opacityOuter = opacity.orUndefined
