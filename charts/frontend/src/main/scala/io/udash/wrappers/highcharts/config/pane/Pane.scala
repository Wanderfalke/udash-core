...
object Pane {
  /**
    ...
    */
  def apply(background: js.UndefOr[js.Array[PaneBackground]] = js.undefined, center: js.UndefOr[js.Array[String | Double]] = js.undefined, endAngle: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double | String] = js.undefined, startAngle: js.UndefOr[Double] = js.undefined): Pane = {
    val backgroundOuter: js.UndefOr[js.Array[PaneBackground]] = background
    ...
    new Pane {
      override val background: js.UndefOr[js.Array[PaneBackground]] = backgroundOuter
